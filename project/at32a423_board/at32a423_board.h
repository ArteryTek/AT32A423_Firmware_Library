...
#ifndef __AT32A423_BOARD_H
#define __AT32A423_BOARD_H
...
/**
  ...
  *   1. at-start-a423 v1.x board
  * if define AT_START_A423_V1, the header file support at-start-a423 v1.x board
  */

#if !defined (AT_START_A423_V1)
#error "please select first the board at-start device used in your application (in at32a423_board.h file)"
#endif
